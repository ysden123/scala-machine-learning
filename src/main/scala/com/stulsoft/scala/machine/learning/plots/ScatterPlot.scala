...
import com.stulsoft.scala.machine.learning.plots.Plot._
...
/**
  ...
  * @param legend Description of legends (title, X-axis, Y-axis)
...
object ScatterPlot {
  ...
  import com.stulsoft.scala.machine.learning.core.Types.ScalaMl.{DblArray, DblPair}
